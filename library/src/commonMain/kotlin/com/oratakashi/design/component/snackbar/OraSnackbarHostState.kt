...
import com.oratakashi.design.component.snackbar.toMillis
...
class OraSnackbarHostState {
     ...
     */
    var currentSnackbarData by mutableStateOf<com.oratakashi.design.component.snackbar.OraSnackbarData?>(null)
        private set
    ...
    suspend fun showSnackbar(
        ...
        duration: com.oratakashi.design.component.snackbar.OraSnackbarDuration =
            if (actionLabel == null) _root_ide_package_.com.oratakashi.design.component.snackbar.OraSnackbarDuration.Short else _root_ide_package_.com.oratakashi.design.component.snackbar.OraSnackbarDuration.Indefinite,
        theme: com.oratakashi.design.component.snackbar.OraSnackbarTheme = _root_ide_package_.com.oratakashi.design.component.snackbar.OraSnackbarTheme.Default,
        size: com.oratakashi.design.component.snackbar.OraSnackbarSize = _root_ide_package_.com.oratakashi.design.component.snackbar.OraSnackbarSize.Large
    ): SnackbarResult =
        showSnackbar(
            _root_ide_package_.com.oratakashi.design.component.snackbar.SnackbarVisualsImpl(
                title,
                message,
                icon,
                actionLabel,
    ...
    /**
     * Shows or queues to be shown a [com.oratakashi.design.component.snackbar.OraSnackbar] at the bottom of the [Scaffold] to which this state
     * is attached and suspends until the snackbar has disappeared.
     *
     ...
     * [SnackbarResult.Dismissed] if snackbar has been dismissed via timeout or by the user
     */
    suspend fun showSnackbar(visuals: com.oratakashi.design.component.snackbar.OraSnackbarVisuals): SnackbarResult = mutex.withLock {
        try {
            return suspendCancellableCoroutine { continuation ->
                currentSnackbarData =
                    _root_ide_package_.com.oratakashi.design.component.snackbar.SnackbarDataImpl(
                        visuals,
                        continuation
                    )
            }
...
/**
 * Host for [com.oratakashi.design.component.snackbar.OraSnackbar]s to be used in [Scaffold] to properly show, hide and dismiss items based
 ...
 * default [com.oratakashi.design.component.snackbar.OraSnackbar], use [com.oratakashi.design.component.snackbar.OraSnackbarHostState.showSnackbar].
 *
 ...
 * @param snackbar the instance of the [com.oratakashi.design.component.snackbar.OraSnackbar] to be shown at the appropriate time with
 * appearance based on the [com.oratakashi.design.component.snackbar.OraSnackbarData] provided as a param
 */
@Composable
fun OraSnackbarHost(
    hostState: com.oratakashi.design.component.snackbar.OraSnackbarHostState,
    modifier: Modifier = Modifier,
    snackbar: @Composable (com.oratakashi.design.component.snackbar.OraSnackbarData) -> Unit = { }
) {
...
//    )
    ...
    _root_ide_package_.com.oratakashi.design.component.snackbar.animation.SlideInSlideOutSnackbarAnimation(
        current = hostState.currentSnackbarData,
        modifier = modifier,
        content = snackbar
    )
