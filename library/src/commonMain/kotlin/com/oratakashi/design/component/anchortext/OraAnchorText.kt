...
fun OraAnchorText(
    ...
    colors: com.oratakashi.design.component.anchortext.OraAnchorTextColor = _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextDefaults.colors(),
    size: com.oratakashi.design.component.anchortext.OraAnchorTextSize = _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextSize.Large,
    ...
    Row(
        horizontalArrangement = Arrangement.spacedBy(_root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextDefaults.ICON_SPACER),
...
private fun LargeEnabledPreview() {
    _root_ide_package_.com.oratakashi.design.foundation.OrataAppTheme {
        Column(
            ...
            _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorText(
                text = "Anchor Text",
                onClick = {},
                size = _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextSize.Large,
                iconLeft = {
                    Icon(
        ...
        Surface {
            Column(
                ...
                _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorText(
                    text = "Anchor Text",
                    onClick = {},
                    size = _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextSize.Medium,
                    iconLeft = {
                        Icon(
                            painter = rememberVectorPainter(FeatherIcons.ArrowLeft),
                            contentDescription = null
    ...
    _root_ide_package_.com.oratakashi.design.foundation.OrataAppTheme {
        Column(
            ...
            _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorText(
                text = "Anchor Text",
                onClick = {},
                size = _root_ide_package_.com.oratakashi.design.component.anchortext.OraAnchorTextSize.Small,
                iconLeft = {
                    Icon(
                        painter = rememberVectorPainter(FeatherIcons.ArrowLeft),
                        contentDescription = null
