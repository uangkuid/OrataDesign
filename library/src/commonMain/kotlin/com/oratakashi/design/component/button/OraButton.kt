...
fun OraButton(
    ...
    style: com.oratakashi.design.component.button.OraButtonColors = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.buttonSolidColors(),
    size: com.oratakashi.design.component.button.OraButtonSize = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.size,
                    ...
                    if (loading) {
                        Box(
                            ...
                            CircularWavyProgressIndicator(
                                modifier = _root_ide_package_.androidx.compose.ui.Modifier.Companion.size(size.iconSize),
                                color = contentColor,
                            )
                        }
                    } else {
                        if (iconLeft != null) {
                            ...
                            Spacer(modifier = _root_ide_package_.androidx.compose.ui.Modifier.Companion.size(size.iconSpacing))
                        }
...
fun OraTonalButton(
    ...
    _root_ide_package_.com.oratakashi.design.component.button.OraButton(
        onClick = onClick,
        modifier = modifier,
        enabled = enabled,
        loading = loading,
        ...
        iconLeft = iconLeft,
        iconRight = iconRight,
        style = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.buttonTonalColors(),
        size = size,
...
fun OraOutlineButton(
    ...
    _root_ide_package_.com.oratakashi.design.component.button.OraButton(
        ...
        iconLeft = iconLeft,
        iconRight = iconRight,
        style = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.buttonOutlineColors(),
        size = size,
        borderStroke = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.outlineButtonBorder(
            enabled
        ),
        contentPadding = contentPadding,
        interactionSource = interactionSource
...
fun OraTransparentButton(
    ...
    _root_ide_package_.com.oratakashi.design.component.button.OraButton(
        ...
        iconLeft = iconLeft,
        iconRight = iconRight,
        style = _root_ide_package_.com.oratakashi.design.component.button.OraButtonDefaults.buttonTransparentColors(),
        size = size,
        borderStroke = null,
        contentPadding = contentPadding,
        interactionSource = interactionSource
